...
On observe la répartition des comparateurs au sein de notre base de plices :
...
On cherche à savoir quel est le comparateur qui classe le mieux notre compagnie :
...
ui <- fluidPage(
  ...
  inputPanel(
    ...
    plotOutput("formuPlot",height = 800)
...
server <- function(input, output) {
  ...
  output$formuPlot <- renderPlot({
    ...
    ggplot(subset(contra_comp, COMPAR==input$COMPAR),aes(x=FORMU))+geom_bar()+ggtitle("Histogramme de la répartition des formules souscrites en fonction du comparateur") +
  xlab("Formules") + ylab("Nombre de formules souscrites")
...
agg=contra_comp[,c("COMPAR","FORMU")]
tree<- d3_nest(agg)
